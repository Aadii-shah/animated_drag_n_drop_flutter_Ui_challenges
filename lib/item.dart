import 'package:animated_drag_drop_flutter/theme.dart';
import 'package:animated_drag_drop_flutter/vm.dart';
...
class _MorphAnimationState extends State<MorphAnimation> with SingleTickerProviderStateMixin {
  ...
  final trailingOpacityTween = Tween<double>(begin: 0, end: 1).chain(CurveTween(curve: Curves.ease));
  ...
  void morph() {
    ...
    cardXTween = Tween(begin: cardOffsets.$1.dx, end: cardOffsets.$2.dx).chain(CurveTween(curve: xCurve));
    cardYTween = Tween(begin: cardOffsets.$1.dy, end: cardOffsets.$2.dy).chain(CurveTween(curve: yCurve));
    ...
    avatarXTween = Tween(begin: avatarOffsets.$1.dx, end: avatarOffsets.$2.dx).chain(CurveTween(curve: xCurve));
    avatarYTween = Tween(begin: avatarOffsets.$1.dy, end: avatarOffsets.$2.dy).chain(CurveTween(curve: yCurve));
    ...
    firstNameXTween = Tween(begin: firstNameOffsets.$1.dx, end: firstNameOffsets.$2.dx).chain(CurveTween(curve: xCurve));

    firstNameYTween = Tween(begin: firstNameOffsets.$1.dy, end: firstNameOffsets.$2.dy).chain(CurveTween(curve: yCurve));
    ...
    lastNameXTween = Tween(begin: lastNameOffsets.$1.dx, end: lastNameOffsets.$2.dx).chain(CurveTween(curve: xCurve));

    lastNameYTween = Tween(begin: lastNameOffsets.$1.dy, end: lastNameOffsets.$2.dy).chain(CurveTween(curve: yCurve));
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const Space.w(Dimensions.xlarge),
                      AnimatedSize(
                        duration: Duration(milliseconds: (morphDuation.inMilliseconds / 2).round()),
                        curve: Curves.easeOut,
                          ...
                          child: Opacity(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                const Space.w(Dimensions.xlarge),
                                Padding(
                                  padding: context.padding.symmetric(horizontal: Dimensions.small).copyWith(left: 0),
                                  child: Text(
                                    item.money.toString(),
                                    style: TextStyles.cardNumber,
                                  ),
